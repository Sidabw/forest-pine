...
# """
# 当前节点角标为i, 其左子节点角标为2i+1, 其右子节点角标为2i+2
# 当前节点角标为i, 其父节点角标为i//2 -1 (除2取整 - 1)
# 原文地址 https://www.cnblogs.com/0zcl/p/6737944.html
# """
#
#
# def sift_down(array, start, end):
#     """
#     初始堆时，从下往上；交换堆顶与堆尾之后，从下往上
#     :param array: 列表的引用
#     :param start:开始索引
#     :param end:结束索引
#     :return:
...
# # range 方法：range(start, stop[, step]) start: 计数从 start 开始。默认是是0；stop: 计数到 stop 结束，不包括stop；step：步长，默认为1
