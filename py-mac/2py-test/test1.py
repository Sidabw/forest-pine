...
class Employee:
    ...
    def __init__(self, name, salary):
        ...
        print
        "I'm ", name, "my salary is ", salary, "----method __init__"
...
print
setattr(employee1, 'age', 10)
print
delattr(employee1, "age")

# py内置属性
print
"employee1.__class__ ", employee1.__class__
print
"employee1.__doc__ ", employee1.__doc__
print
"employee1.__module__ ", employee1.__module__
